...
class AugmentedSequential(nn.Sequential):
    def __init__(self, *flow_blocks, d_model,n_flow_layers,nhead,flowattlayer,diff_layers,n_times,window,Fea,ratio,betamin,betamax,U_d,only_transformer,diffst,diffusion_conditioning,infer_samples=1,device=None):
